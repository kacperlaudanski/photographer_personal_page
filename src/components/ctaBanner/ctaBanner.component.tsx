...
export const CtaBanner: React.FC = (): JSX.Element => (
  <div className='flex flex-col md:flex-row relative justify-between md:items-center px-6 md:px-12 py-10 rounded-2xl bg-[rgb(247,220,245)] overflow-hidden'>
    <div className='flex flex-col'>
      <span className='hidden lg:block absolute right-46 top-30 -rotate-15 -translate-y-1/2 text-[10rem] font-handwrite text-pink-100 select-none whitespace-nowrap'>
        do zobaczenia
      </span>
      <div className='flex flex-col gap-3 z-10'>
        <span className='font-mono text-accent-pink text-xs uppercase'>
          Napisz do mnie
        </span>
        <h2 className='font-display text-3xl md:text-5xl mt-2 font-semi-bold text-stone-800'>
          Masz pomysł na sesję?
        </h2>
        <span className='text-gradient-brand font-handwrite text-5xl'>
          Pogadajmy.
        </span>
        <p className='text-md text-stone-500 max-w-100 font-body italic'>
